...
# _known_primes = [x for x in xrange(5000000) if is_prime(x)]

# print _known_primes[-1]

# print is_prime(4999999)
# print is_prime(4999999+1)
...
print is_prime(1643808006803554439230129854961492699151386107534013432918073439524138264842370630061369715394739134090922937332590384720397133335969549256322620979036686633213903952966175107096769180017646161851573147596390153)
"""

"""
for ii in xrange(26+10):
    pp = 43142746595714191 + 5283234035979900 * ii
    print is_prime(pp)
"""

print [is_prime(43142746595714191 + 5283234035979900 * ii) for ii in xrange(26)]
